...
then
	...
	echo "param 6: Incremental Compilation. if not set, clean."
	exit 1
fi
...
#setup jdk 1.7
source /opt/choose_java_version.sh < "$AML_SCRIPTS_PATH/android/jdk17"
